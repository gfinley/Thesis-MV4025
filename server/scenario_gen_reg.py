...
scenario_generator_registry = {
    ...
    "island_small-6" : (scenario_navy.island_ocean_factory, {'size':6, "number_of_islands":4, 'min_units':1, 'max_units':3}),
    "island_large-6" : (scenario_navy.island_large_ocean_factory, {'size':6, "number_of_islands":4, 'min_units':1, 'max_units':3, 'max_phases':20}),
}