...
import test_experiment_function

# Run experiment
result_histogram = test_experiment_function.do_experiment(task['seed'], task['number'])
# Compute MOEs
moe_d = {
    "one18s": result_histogram[1],
    "two18s": result_histogram[2],
    "three18s": result_histogram[3], 
    "more18s": result_histogram[4]+result_histogram[5]+result_histogram[6]
}
