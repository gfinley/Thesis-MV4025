...
env = gym_interface.GymEnvironment(role="blue", versusAI="pass-agg-fog", scenario="fog-inf-7", saveReplay=False, actions19=False, ai="gym14", verbose=False, scenarioSeed=4025, scenarioCycle=0)
...
model.set_env(env)
save_name = "model_{}_{}".format(args.model, args.length)
log_save_name = "log/model_{}_{}".format(args.model, args.length)
